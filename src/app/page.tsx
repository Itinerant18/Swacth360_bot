                                ...
                                {showSaveModal ? (
                                    <div className="flex items-center gap-2 p-2 skeuo-card rounded-xl animate-fade-up">
                                        ...
                                        <button
                                            ...
                                            title="Cancel saving session"
                                            aria-label="Cancel saving session"
                                        >
                            ...
                            <>
                                <form onSubmit={handleSubmit} className="relative flex items-center">
                                    ...
                                    <button type="submit" disabled={isLoading || isLoadingHistory || !input.trim()}
                                        className="absolute right-1.5 sm:right-2 p-2 sm:p-2.5 skeuo-brass rounded-lg sm:rounded-xl disabled:opacity-30" title="Send message" aria-label="Send message">
