                                ...
                                <div className="group relative">
                                    ...
                                    {!streamingMessageId && onEdit && (
                                        <button
                                            ...
                                            className="absolute -left-8 top-0 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#CA8A04] p-1 rounded text-white/40 hover:text-white transition-all"
                                            title="Edit message"
