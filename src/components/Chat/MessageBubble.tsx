                                ...
                                <div className="group relative">
                                    ...
                                    {!streamingMessageId && onEdit && (
                                        <button
                                            ...
                                            className="absolute -left-8 top-0 opacity-0 group-hover:opacity-100 p-1 rounded text-white/40 hover:text-white transition-all focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#CA8A04]"
                                            title="Edit message"
