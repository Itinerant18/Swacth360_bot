                ...
                <div className="px-3 border-b border-[#D6CFC4]">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-2">
                            <button onClick={onClose} className="flex items-center justify-center w-10 h-10 rounded-lg text-[#78716C] hover:text-[#1C1917] hover:bg-black/5 transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#CA8A04]" title="Close sidebar" aria-label="Close sidebar">
                        ...
                        <button onClick={onNew} className="p-1.5 rounded-lg text-[#78716C] hover:text-[#CA8A04] hover:bg-[#CA8A04]/10 transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#CA8A04]" title="New conversation" aria-label="New conversation">
                                    ...
                                    {items.map((conversation) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                role="button"
                                                tabIndex={0}
                                                className={`group relative rounded-2xl border px-3 py-3 cursor-pointer transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[#CA8A04] ${isActive
