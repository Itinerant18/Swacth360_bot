                                            ...
                                            >
                                                ...
                                                <div className="absolute right-2 top-2 flex items-center gap-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`rounded-md p-1 text-[#A8A29E] hover:text-red-600 hover:bg-red-50 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none transition-all ${isActive || isConversationLoading ? 'opacity-0 pointer-events-none' : 'opacity-0 group-hover:opacity-100'}`}
                                                        title="Delete"
                                                        aria-label="Delete"
                                                    >
